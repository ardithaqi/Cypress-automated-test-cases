export class ModalPage {
  ...
  dialogSection() {
    ...
    cy.contains("nb-card", "Open Dialog")
      ...
      .then((button) => {
        ...
        cy.contains("nb-card", "This is a title passed to the dialog component")
          .find("button", "Dismiss Dialog")
          .click();
        cy.wrap(button).eq(1).click();
        cy.contains("nb-card", "Template Dialog")
          .find("button", "Close Dialog")
          .click();
      });

    //Open Without Backdrop
    cy.contains("nb-card", "Open Without Backdrop")
      .find("button")
      .then((button) => {
        cy.wrap(button).eq(0).click();
        cy.get("body").type(" ");
    ...
    cy.contains("nb-card", "Open Without Esc Close")
      .find("button")
      .then((button) => {
        cy.wrap(button).eq(0).click();
  ...
  windowSection() {
    //Window Form
    cy.contains("nb-card", "Window Form")
      .find("button")
      .then((button) => {
        cy.wrap(button).eq(0).click();
    ...
    cy.contains("nb-card", "Window Without Backdrop")
      .find("button")
      .then((button) => {
        cy.wrap(button).eq(0).click();
        cy.get("body").type("{esc}");
  ...
  popoverSection() {
    //Popover Position
    cy.contains("nb-card", "Popover Position")
      .find("button")
      .each((button) => {
    ...
    //Simple Popovers
    cy.contains("nb-card", "Simple Popovers")
      .find("button")
      .each((button) => {
    ...
    //Template Popovers
    cy.contains("nb-card", "Template Popovers")
      .find("button")
      .then((button) => {
        cy.wrap(button).eq(0).click();
          ...
          cy.wrap(formsMenu)
            ...
            .then((overlay) => {
              ...
              cy.wrap(overlay)
                ...
                .type(
                  "Congratulaions on the new years eve and shit brrap papapa"
                );
    ...
    //Component Popovers
    cy.contains("nb-card", "Component Popovers")
      .find("button")
      .then((button) => {
        cy.wrap(button).eq(0).click();
        cy.get("nb-popover").then((tabsMenu) => {
          cy.wrap(tabsMenu)
            ...
            .then((list) => {
              ...
              cy.get('[ng-reflect-tab-title="What\'s up?"]')
                .invoke("text")
                .should("contain", "Such a wonderful day!");
              cy.wrap(list)
                .eq(1)
                .find("a")
                .click()
                .should("contain", "Second Tab");
              cy.get('[tabtitle="Second Tab"]')
                .invoke("text")
                .should("contain", "Indeed!");
            });
        });
        ...
        cy.get("nb-popover")
          .find("nb-card-body")
          .invoke("text")
          .should("contain", "Far far away, behind the word mountains");
      });

    //Event Debouncing
    cy.contains("nb-card", "Event Debouncing")
      .find("button")
      .each((button) => {
